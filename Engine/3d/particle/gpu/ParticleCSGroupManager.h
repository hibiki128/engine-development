...
class ParticleCSGroupManager
{
  ...
  public:
    ...
    void CreateParticleCSGroup(const std::string &groupName, const std::string &fileName, uint32_t maxParticleCount = 10000, const std::string &texturePath = {}, BlendMode blendMode = BlendMode::Add);
    ...
    /// <param name="texturePath">テクスチャパス（省略可）</param>
    /// <param name="blendMode">ブレンドモード</param>
    void CreatePrimitiveParticleCSGroup(const std::string &groupName, PrimitiveType type, uint32_t maxParticleCount = 10000, const std::string &texturePath = {}, BlendMode blendMode = BlendMode::Add);
